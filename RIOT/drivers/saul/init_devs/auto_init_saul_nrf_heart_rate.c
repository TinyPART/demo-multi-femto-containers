 ...
 */
extern saul_driver_t nrf_hrt_saul_driver;

/**
 * @brief   Reference the information for saul registry
 */
extern saul_reg_info_t nrf_hrt_saul_info;

void auto_init_nrf_hrt(void)
{
    saul_reg_entry.dev = NULL;
    saul_reg_entry.name = nrf_hrt_saul_info.name;
    saul_reg_entry.driver = &nrf_hrt_saul_driver;
    /* add to registry */
